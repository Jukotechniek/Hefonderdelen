  ...
  const handleAiHelp = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        alert(`AI kon geen tekst genereren: ${errorMessage}`);
      ...
      if (!generatedText || generatedText.trim() === '') {
        alert("AI heeft geen tekst gegenereerd. Probeer het opnieuw.");
        setIsGenerating(false);
        return;
      }
      ...
      alert(`AI kon geen tekst genereren: ${error.message || 'Onbekende fout'}. Probeer het later opnieuw.`);
    } finally {
      setIsGenerating(false);
    }
  };
